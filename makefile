...
${build_dir}/src/autodiff/diff1.o: src/autodiff/diff1.cpp | ${build_dir}/src/autodiff 
	g++ ${flags} -c src/autodiff/diff1.cpp -o ${build_dir}/src/autodiff/diff1.o
${build_dir}/src/autodiff:
	mkdir -p $@
...
${build_dir}/src/optimize:
	mkdir -p $@
${build_dir}/src/petrinet/petri_net.o: src/petrinet/petri_net.cpp | ${build_dir}/src/petrinet 
	g++ ${flags} -c src/petrinet/petri_net.cpp -o ${build_dir}/src/petrinet/petri_net.o
${build_dir}/src/petrinet:
	mkdir -p $@
${build_dir}/src/petrinet/reach_graph.o: src/petrinet/reach_graph.cpp | ${build_dir}/src/petrinet 
	g++ ${flags} -c src/petrinet/reach_graph.cpp -o ${build_dir}/src/petrinet/reach_graph.o
...
${build_dir}/test/test_petri_net.o: test/test_petri_net.cpp | ${build_dir}/test 
	g++ ${gtest_flags} ${flags} -c test/test_petri_net.cpp -o ${build_dir}/test/test_petri_net.o
...
${build_dir}/test/test_autodiff.o: test/test_autodiff.cpp | ${build_dir}/test 
	g++ ${gtest_flags} ${flags} -c test/test_autodiff.cpp -o ${build_dir}/test/test_autodiff.o
...
${build_dir}/${gtest_dir}/src:
	mkdir -p $@
${build_dir}/utest: ${build_dir}/src/autodiff/diff1.o ${build_dir}/src/graph/digraph_algo.o ${build_dir}/src/matvec/vector.o ${build_dir}/src/matvec/matvec_oper.o ${build_dir}/src/matvec/blas.o ${build_dir}/src/matvec/matrix.o ${build_dir}/src/spmatvec/spblas.o ${build_dir}/src/spmatvec/spmatvec_oper.o ${build_dir}/src/spmatvec/spvector.o ${build_dir}/src/spmatvec/spmatrix.o ${build_dir}/src/debug/debug_utils.o ${build_dir}/src/splinalg/splinalg_eigen.o ${build_dir}/src/splinalg/splinalg_decomp.o ${build_dir}/src/splinalg/splinalg_solve.o ${build_dir}/src/optimize/optimize.o ${build_dir}/src/petrinet/petri_net.o ${build_dir}/src/petrinet/reach_graph.o ${build_dir}/src/linalg/linalg_least_square.o ${build_dir}/src/linalg/linalg_decomp.o ${build_dir}/src/linalg/linalg_solve.o ${build_dir}/test/test_digraph.o ${build_dir}/test/test_spmatrix.o ${build_dir}/test/test_optimize.o ${build_dir}/test/test_main.o ${build_dir}/test/test_linalg.o ${build_dir}/test/test_spblas.o ${build_dir}/test/test_petri_net.o ${build_dir}/test/test_matvec_oper.o ${build_dir}/test/test_common.o ${build_dir}/test/test_blas.o ${build_dir}/test/test_splinalg.o ${build_dir}/test/test_large.o ${build_dir}/test/common.o ${build_dir}/test/test_autodiff.o ${build_dir}/test/test_matrix.o ${build_dir}/${gtest_dir}/src/gtest-all.o  | ${build_dir}
	g++ ${build_dir}/src/autodiff/diff1.o ${build_dir}/src/graph/digraph_algo.o ${build_dir}/src/matvec/vector.o ${build_dir}/src/matvec/matvec_oper.o ${build_dir}/src/matvec/blas.o ${build_dir}/src/matvec/matrix.o ${build_dir}/src/spmatvec/spblas.o ${build_dir}/src/spmatvec/spmatvec_oper.o ${build_dir}/src/spmatvec/spvector.o ${build_dir}/src/spmatvec/spmatrix.o ${build_dir}/src/debug/debug_utils.o ${build_dir}/src/splinalg/splinalg_eigen.o ${build_dir}/src/splinalg/splinalg_decomp.o ${build_dir}/src/splinalg/splinalg_solve.o ${build_dir}/src/optimize/optimize.o ${build_dir}/src/petrinet/petri_net.o ${build_dir}/src/petrinet/reach_graph.o ${build_dir}/src/linalg/linalg_least_square.o ${build_dir}/src/linalg/linalg_decomp.o ${build_dir}/src/linalg/linalg_solve.o ${build_dir}/test/test_digraph.o ${build_dir}/test/test_spmatrix.o ${build_dir}/test/test_optimize.o ${build_dir}/test/test_main.o ${build_dir}/test/test_linalg.o ${build_dir}/test/test_spblas.o ${build_dir}/test/test_petri_net.o ${build_dir}/test/test_matvec_oper.o ${build_dir}/test/test_common.o ${build_dir}/test/test_blas.o ${build_dir}/test/test_splinalg.o ${build_dir}/test/test_large.o ${build_dir}/test/common.o ${build_dir}/test/test_autodiff.o ${build_dir}/test/test_matrix.o ${build_dir}/${gtest_dir}/src/gtest-all.o  ${link_flags} -o ${build_dir}/utest
${build_dir}:
	mkdir -p $@
${build_dir}/libscigg.a: ${build_dir}/src/autodiff/diff1.o ${build_dir}/src/graph/digraph_algo.o ${build_dir}/src/matvec/vector.o ${build_dir}/src/matvec/matvec_oper.o ${build_dir}/src/matvec/blas.o ${build_dir}/src/matvec/matrix.o ${build_dir}/src/spmatvec/spblas.o ${build_dir}/src/spmatvec/spmatvec_oper.o ${build_dir}/src/spmatvec/spvector.o ${build_dir}/src/spmatvec/spmatrix.o ${build_dir}/src/debug/debug_utils.o ${build_dir}/src/splinalg/splinalg_eigen.o ${build_dir}/src/splinalg/splinalg_decomp.o ${build_dir}/src/splinalg/splinalg_solve.o ${build_dir}/src/optimize/optimize.o ${build_dir}/src/petrinet/petri_net.o ${build_dir}/src/petrinet/reach_graph.o ${build_dir}/src/linalg/linalg_least_square.o ${build_dir}/src/linalg/linalg_decomp.o ${build_dir}/src/linalg/linalg_solve.o  | ${build_dir}
	ar crf ${build_dir}/libscigg.a ${build_dir}/src/autodiff/diff1.o ${build_dir}/src/graph/digraph_algo.o ${build_dir}/src/matvec/vector.o ${build_dir}/src/matvec/matvec_oper.o ${build_dir}/src/matvec/blas.o ${build_dir}/src/matvec/matrix.o ${build_dir}/src/spmatvec/spblas.o ${build_dir}/src/spmatvec/spmatvec_oper.o ${build_dir}/src/spmatvec/spvector.o ${build_dir}/src/spmatvec/spmatrix.o ${build_dir}/src/debug/debug_utils.o ${build_dir}/src/splinalg/splinalg_eigen.o ${build_dir}/src/splinalg/splinalg_decomp.o ${build_dir}/src/splinalg/splinalg_solve.o ${build_dir}/src/optimize/optimize.o ${build_dir}/src/petrinet/petri_net.o ${build_dir}/src/petrinet/reach_graph.o ${build_dir}/src/linalg/linalg_least_square.o ${build_dir}/src/linalg/linalg_decomp.o ${build_dir}/src/linalg/linalg_solve.o 
deps:=${build_dir}/src/autodiff/diff1.d ${build_dir}/src/graph/digraph_algo.d ${build_dir}/src/matvec/vector.d ${build_dir}/src/matvec/matvec_oper.d ${build_dir}/src/matvec/blas.d ${build_dir}/src/matvec/matrix.d ${build_dir}/src/spmatvec/spblas.d ${build_dir}/src/spmatvec/spmatvec_oper.d ${build_dir}/src/spmatvec/spvector.d ${build_dir}/src/spmatvec/spmatrix.d ${build_dir}/src/debug/debug_utils.d ${build_dir}/src/splinalg/splinalg_eigen.d ${build_dir}/src/splinalg/splinalg_decomp.d ${build_dir}/src/splinalg/splinalg_solve.d ${build_dir}/src/optimize/optimize.d ${build_dir}/src/petrinet/petri_net.d ${build_dir}/src/petrinet/reach_graph.d ${build_dir}/src/linalg/linalg_least_square.d ${build_dir}/src/linalg/linalg_decomp.d ${build_dir}/src/linalg/linalg_solve.d ${build_dir}/test/test_digraph.d ${build_dir}/test/test_spmatrix.d ${build_dir}/test/test_optimize.d ${build_dir}/test/test_main.d ${build_dir}/test/test_linalg.d ${build_dir}/test/test_spblas.d ${build_dir}/test/test_petri_net.d ${build_dir}/test/test_matvec_oper.d ${build_dir}/test/test_common.d ${build_dir}/test/test_blas.d ${build_dir}/test/test_splinalg.d ${build_dir}/test/test_large.d ${build_dir}/test/common.d ${build_dir}/test/test_autodiff.d ${build_dir}/test/test_matrix.d ${build_dir}/${gtest_dir}/src/gtest-all.d 
